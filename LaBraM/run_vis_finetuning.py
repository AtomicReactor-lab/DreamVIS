...
from mydatamatch.vis_data_prep import VisQueryDataset
...
def get_dataset(args):
    # 使用我们的VisQueryDataset替代原来的数据集
    data_dir = "/home/shiyao/EEG/eegprocessed/labeled"  # 你的labeled数据目录
    train_dataset = VisQueryDataset(data_dir, phase='train')
    val_dataset = VisQueryDataset(data_dir, phase='val')
    test_dataset = VisQueryDataset(data_dir, phase='test')
...
def main(args, ds_init):
    ...
    args.nb_classes = len(dataset_train.query_to_class)  # 设置为SQL查询组合的总数
